...
public class ArrayIntList {
	    ...
	    //功課看這裡!!!! return the position of the first occurrence of a value (-1 if not found)
		...
		//insert a given value at a given index, must shift the subsequent value to the right
	  ...
	  //find all the elements with an given value and replace them with a different value
